            ...
            <td>
              <select name="1.2">
                <option selected value="<?php echo $data->data[0]->Activity ?>">
                  <?php echo $data->data[0]->Activity ?>(Prevous Value)
                </option>
            ...
            <td>
              <select name="2.2">
                <option selected value="<?php echo $data->data[1]->Activity ?>">
                  <?php echo $data->data[1]->Activity ?>(Prevous Value)
                </option>
                <option value="N/A">N/A</option>
                <option value="NO">NO</option>
                <option value="YES">YES</option>
            ...
            <td>
              <select name="3.2">
                <option selected value="<?php echo $data->data[2]->Activity ?>">
                  <?php echo $data->data[2]->Activity ?>(Prevous Value)
                </option>
                <option value="N/A">N/A</option>
                <option value="NO">NO</option>
                <option value="YES">YES</option>
            ...
            <td>
              <select name="4.2">
                <option selected value="<?php echo $data->data[3]->Activity ?>">
                  <?php echo $data->data[3]->Activity ?>(Prevous Value)
                </option>
                <option value="N/A">N/A</option>
                <option value="NO">NO</option>
                <option value="YES">YES</option>
            ...
            <td>
              <select name="5.2">
                <option selected value="<?php echo $data->data[4]->Activity ?>">
                  <?php echo $data->data[4]->Activity ?>(Prevous Value)
                </option>
                <option value="N/A">N/A</option>
                <option value="NO">NO</option>
                <option value="YES">YES</option>
